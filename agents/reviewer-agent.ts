...
- Call mcp__levys-awesome-mcp__compare_plan_progress with the provided git_commit_hash
...
- session_id: For report generation
- git_commit_hash: To locate plan/progress files
